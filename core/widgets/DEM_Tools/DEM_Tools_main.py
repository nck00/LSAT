...
class Hillshade(QMainWindow):
    def __init__(self, projectLocation="", parent=None):
        ...
        self.setWindowIcon(QIcon('icons:hillshade.png'))
...
class Aspect(QMainWindow):
    def __init__(self, projectLocation="", parent=None):
        ...
        self.setWindowIcon(QIcon('icons:aspect.png'))
        self.progress = QProgressBar()
        self.statusBar().addPermanentWidget(self.progress)
        self.message = Messenger()
        self.fileDialog = CustomFileDialog()
...
class Roughness(QMainWindow):
    def __init__(self, projectLocation="", parent=None):
        ...
        self.setWindowIcon(QIcon('icons:roughness.png'))
        self.progress = QProgressBar()
        self.statusBar().addPermanentWidget(self.progress)
        self.message = Messenger()
        self.fileDialog = CustomFileDialog()
...
class TRI(QMainWindow):
    def __init__(self, projectLocation="", parent=None):
        ...
        self.setWindowIcon(QIcon('icons:TRI.png'))
        self.progress = QProgressBar()
        self.statusBar().addPermanentWidget(self.progress)
        self.message = Messenger()
        self.fileDialog = CustomFileDialog()
...
class TPI(QMainWindow):
    def __init__(self, projectLocation="", parent=None):
        ...
        self.setWindowIcon(QIcon('icons:tpi.png'))
        self.progress = QProgressBar()
        self.statusBar().addPermanentWidget(self.progress)
        self.message = Messenger()
        self.fileDialog = CustomFileDialog()
...
class CalculateSlope(QMainWindow):
    def __init__(self, projectLocation="", parent=None):
        ...
        self.ui = Ui_Slope()
        self.ui.setupUi(self)
        self.setWindowIcon(QIcon('icons:Slope.png'))
